...
```
## Imagens e ícones
Fica a critério de quem estiver implementando o sistema quais imagens e ícones usar, *Sabendo que é necessário manter os seus nomes para serem chamados corretamente*.
